...
<p><?php printf(__("Auction has been outbid. Auction url <a href='%s'>%s</a>.", 'ultimate-woocommerce-auction-custom'), $auction_url, $auction_title); ?></p>
...
<div>
  <p><?php _e('If you want to bid a new amount, click here', 'ultimate-woocommerce-auction-custom'); ?>
    <a href="<?php echo esc_url($auction_url); ?>"><?php echo esc_attr($auction_title); ?></a>
  </p>
</div>
