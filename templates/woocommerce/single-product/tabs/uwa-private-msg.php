...
<div class="private_msg_main">
	<h2><?php _e('Send Private Message', 'ultimate-woocommerce-auction-custom'); ?></h2>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td class="name">
							<input type="text" placeholder="<?php _e('Your Name', 'ultimate-woocommerce-auction-custom') ?>" class="uwa_pri_name" id="uwa_pri_name" name="uwa_pri_name" value="<?php echo esc_attr($user_login); ?>"></br>
				...
				<?php } else { ?>
					...
					<input type="hidden" placeholder="<?php _e('Your Name', 'ultimate-woocommerce-auction-custom') ?>" class="uwa_pri_name" id="uwa_pri_name" name="uwa_pri_name" value="<?php echo esc_attr($user_login); ?>">
				...
				<tr>
					...
					<td class="name">
						<textarea id="uwa_pri_message" placeholder="<?php _e('Message Detail', 'ultimate-woocommerce-auction-custom') ?>" class="uwa_pri_message"></textarea>
						</br>
				...
				<tr>
					<td>
						<button id="uwa_private_send" class="button alt uwa_private_send">
							<?php _e('Send', 'ultimate-woocommerce-auction-custom') ?>
						</button>
					</td>
					<td></td>
				</tr>
