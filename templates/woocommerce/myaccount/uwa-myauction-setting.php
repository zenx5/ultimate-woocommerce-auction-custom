...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	woocommerce_form_field('uwa_disable_display_user_name', array(
		...
		'label'         => __('Display your name publicly', 'ultimate-woocommerce-auction-custom'),
		'required'  => false,
		'default' => 1
	...
	<p>
		...
		<input type="submit" class="woocommerce-Button button" name="save_uwa_auctions_settings" value="<?php esc_attr_e('Save changes', 'ultimate-woocommerce-auction-custom'); ?>" />
