...
<div class="wrap" id="uwa_auction_setID">
	...
	<div class="uwa_setting_right">
		...
		<div class="box_get_premium">
			<a href="#?utm_source=woo plugin&utm_medium=vertical banner&utm_campaign=learn-more-button" target="_blank"> <img src="<?php echo esc_url(WOO_UA_ASSETS_URL); ?>/images/UWCA_col.jpg" alt="" /> </a>
		</div>
