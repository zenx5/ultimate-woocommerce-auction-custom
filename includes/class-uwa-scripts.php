...
class UWA_Scripts
{
	...
	public function uwa_register_front_scripts($hook_sufix)
	{
		...
		$multi_lang_data = array(
			'labels' => array(
				'Years' => __('Years', 'ultimate-woocommerce-auction-custom'),
				'Months' => __('Months', 'ultimate-woocommerce-auction-custom'),
				'Weeks' => __('Weeks', 'ultimate-woocommerce-auction-custom'),
				'Days' => __('Days', 'ultimate-woocommerce-auction-custom'),
				'Hours' => __('Hours', 'ultimate-woocommerce-auction-custom'),
				'Minutes' => __('Minutes', 'ultimate-woocommerce-auction-custom'),
				'Seconds' => __('Seconds', 'ultimate-woocommerce-auction-custom'),
			),
			'labels1' => array(
				'Year' => __('Year', 'ultimate-woocommerce-auction-custom'),
				'Month' => __('Month', 'ultimate-woocommerce-auction-custom'),
				'Week' => __('Week', 'ultimate-woocommerce-auction-custom'),
				'Day' => __('Day', 'ultimate-woocommerce-auction-custom'),
				'Hour' => __('Hour', 'ultimate-woocommerce-auction-custom'),
				'Minute' => __('Minute', 'ultimate-woocommerce-auction-custom'),
				'Second' => __('Second', 'ultimate-woocommerce-auction-custom'),
			),
			'compactLabels' => array(
				'y' => __('y', 'ultimate-woocommerce-auction-custom'),
				'm' => __('m', 'ultimate-woocommerce-auction-custom'),
				'w' => __('w', 'ultimate-woocommerce-auction-custom'),
				'd' => __('d', 'ultimate-woocommerce-auction-custom'),
			),
		);
		...
		$uwa_custom_data = array(
			'expired' => __('Auction has Expired!', 'ultimate-woocommerce-auction-custom'),
			'gtm_offset' => get_option('gmt_offset'),
			'started' => __('Auction Started! Please refresh page.', 'ultimate-woocommerce-auction-custom'),
			'outbid_message' =>  wc_get_template_html("notices/error.php", array('messages' => array(__("You have been overbidded!", 'ultimate-woocommerce-auction-custom')))),
