...
class UWA_Scripts {
	...
	public function uwa_register_admin_scripts( $hook_sufix ) {
		...
		wp_localize_script('uwa-admin', 'WooUa', array('ajaxurl' => admin_url('admin-ajax.php'), 'ua_nonce' => wp_create_nonce('UtAajax-nonce') ,'calendar_image'=> WC()->plugin_url() . '/assets/images/calendar.png','reguler_required_message'=>__('Please enter Regular price.', 'ultimate-woocommerce-auction')));
