jQuery(document).ready(function($){
	...
	jQuery("#woo_ua_auction_end_date").keypress(function(event) {event.preventDefault();});
	...
	// End Bid Now
	jQuery('.woo_end_now').on('click',function(event){
	...
	// Cancel Last bid
	jQuery('.woo_ua-table .bid_action a:not(.disabled)').on('click',function(event){
